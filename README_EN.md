# WhiteVPN Ч Block unwanted resources on your VPN server

[–усска€ верси€](README.md)
...
Buttons:
- **Update IP and domains** Ч refresh blocklists
- **Enable/Disable protection** Ч toggle all protection
- **Restart services** Ч restart Unbound and iptables
- **Server status** Ч uptime, disk, memory, service status
- **Download logs** Ч download bot log file
- **Docker: status** Ч Docker blocking status
- **Docker: on / Docker: off** Ч toggle Docker blocking
...
+-- blocked-ips/
¶   L-- block_ips.py            # IP blocklist download and apply
L-- blocked-domains/
    L-- block_domains.py        # Domain blocklist download and apply
```
